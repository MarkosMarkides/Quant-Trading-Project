    ...
    for _,row in df.iterrows():
        ...
        if not bar:
            bar = {
                ...
                'mid_o': row[price_col],  # Open price
                'mid_h': row[price_col],  # High price
                'mid_l': row[price_col],  # Low price
                'mid_c': row[price_col],  # Close price
            ...
            # Update the bar
            bar['mid_h'] = max(bar['mid_h'], row[price_col])  # High price
            bar['mid_l'] = min(bar['mid_l'], row[price_col])  # Low price
            bar['mid_c'] = row[price_col]  # Close price
