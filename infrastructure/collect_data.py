...
def run_collection(ic: InstrumentCollection, api: OandaApi, currencies=["EUR", "USD"], years=4, granularities=["M5"]):
        ...
        for p2 in currencies:
            ...
            if pair in ic.instruments_dict.keys():
                for granularity in granularities:
                    ...
                    start_date = (pd.Timestamp.utcnow() - pd.DateOffset(years=years)).isoformat()
                    collect_data(
                        pair,
                        granularity,
                        start_date,
